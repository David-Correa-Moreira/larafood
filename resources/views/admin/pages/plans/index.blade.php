    ...
    <div class="card">
        <div class="card-header">
            <form action="{{ route('plans.search') }}" method="POST" class="form form-inline float-right">
                @csrf
                <input type="search" name="filter" placeholder="Pesquisa" class="form-control" value="{{ $filters['filter'] ?? '' }}"> <!-- recebe o valor do filtro -->
        ...
        <div class="card-footer">
            <!-- se a variavel filter for enviada para view -->
            @if (isset($filters))
            <!-- metodo appends respeita o valor pesquisado em cada paginação -->
